...
#     pass
from dataset import replace_patterns, SuperComputerDataset, BGL

# проверка на разных строках
lines = [
    "- 1104566400 2005.01.01 src@sadmin2 CROND[32483]: connect to 10.1.2.3 failed",
    "- 1104566401 2005.01.01 src@sadmin3 CROND[32484]: kernel panic at /var/log/x",
    "- 1104566402 2005.01.01 src@sadmin4 CROND[32485]: auth failed for user root",
]
for l in lines:
    print(repr(replace_patterns(l)))